...
GOOGLE_API_KEY = "AIzaSyD4lULdKzwzUzIwDaY80TWTx5tBneVIuqU"
...
# Streamlit interface
st.set_page_config(page_title="Simple ChatBot By JAMIL", layout="centered")

st.title("✨ Simple ChatBot By Jamil ✨")
